document.addEventListener("DOMContentLoaded", async () => {
  ...
  image.addEventListener("change", async e => {
    if (e.target.files.length < 1) {
      agentphoto.src = "/files/photo/default.jpg";
    ...
    reader.addEventListener("load", e => (agentphoto.src = reader.result));
  ...
  document.getElementById("photoform").addEventListener("submit", async e => {
    ...
    try {
      ...
      const result = await postRequest(`agent/updatephoto`, data);
  ...
  document.getElementById("editprofileform").addEventListener("submit", async e => {
    ...
    try {
      ...
      const result = await postRequest(`agent/updateprofile`, data);
  ...
  document.getElementById("accountdetailform").addEventListener("submit", async e => {
    ...
    try {
      ...
      const result = await postRequest(`agent/submitbankdetails`, data);
