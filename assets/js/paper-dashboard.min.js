  ...
  $(document).ready(function () {
    0 == $(".full-screen-map").length &&
      ...
      0 != $(".navbar[color-on-scroll]").length &&
        (paperDashboard.checkScrollForTransparentNavbar(), $(window).on("scroll", paperDashboard.checkScrollForTransparentNavbar)),
      $(".form-control")
        .on("focus", function () {
      ...
      0 != $(".sidebar-mini").length && (sidebar_mini_active = !0),
        $("#minimizeSidebar").click(function () {
          ...
          1 == sidebar_mini_active
            ? ($("body").addClass("sidebar-mini"), (sidebar_mini_active = !0), paperDashboard.showSidebarMessage("Sidebar mini activated..."))
            : ($("body").removeClass("sidebar-mini"), (sidebar_mini_active = !1), paperDashboard.showSidebarMessage("Sidebar mini deactivated..."));
