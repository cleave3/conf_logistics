            ...
            <div class="content">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="/admin/waybillrequests">Waybills Requests</a>
                    </li>
                ...
                <div class="waybill print-container">
                    <div class="card">
                        <div class="card-header">
                            <p class="text-left text-uppercase"><b>SELLER :</b> <?= strtoupper($waybill["companyname"]) ?></p>
                            <p class="text-left text-uppercase"><b>Seller Email :</b> <?= $waybill["email"] ?></p>
                            <p class="text-left text-uppercase"><b>Seller Telephone :</b> <?= $waybill["telephone"] ?></p>
                        </div>
                        <div class="card-body">
