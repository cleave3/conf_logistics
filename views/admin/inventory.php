            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">SELLERS ITEMS</h4>
                    </div>
                            ...
                            <tbody role="rowgroup" id="inventorylist">
                                ...
                                ?>
                                    <tr role="row">
                                        ...
                                        <td role="cell" data-label="COMPANY NAME"><?= $inventory["companyname"] ?></td>
                                        <td role="cell" data-label="SELLER TELEPHONE"><?= $inventory["telephone"] ?></td>
